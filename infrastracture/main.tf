...
module "fargate" {
  ...
  cognito_user_pool_client_id = aws_cognito_user_pool_client.tic-tac-toe-user-pool-client.id
  cognito_user_pool_id        = aws_cognito_user_pool.tic-tac-toe-user-pool.id
