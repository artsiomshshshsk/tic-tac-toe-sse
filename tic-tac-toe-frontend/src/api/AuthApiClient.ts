...
export async function signUp(username: string, email: string, password: string, avatar: File): Promise<void> {
    ...
    await apiClient.post('/sign-up', formData, {
        headers: {
...
export async function confirm({username, confirmationCode}: {
    username: string;
